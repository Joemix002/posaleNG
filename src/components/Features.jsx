...
const FEATURES = [
  ...
  },
  {
    ...
    body: 'Three roles — admin, manager and cashier — each with a 4-digit passcode. Managers run inventory and reports; cashiers just sell. Only the owner grants extra privileges.',
  ...
  },
  {
    ...
    body: 'Open more than one shop? Create multiple stores under the same business — each with its own stock and sales, all managed from your admin account.',
    icon: <svg width="20" height="20" viewBox="0 0 24 24" {...stroke}><path d="M3 9l1.5-5h15L21 9" /><path d="M4 9v11a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1V9" /><path d="M9 21v-6h6v6" /></svg>,
  },
  {
